...
exports.swaggerConfig = exports.app = void 0;
const zod_openapi_1 = require("@hono/zod-openapi");
const swagger_ui_1 = require("@hono/swagger-ui");
const index_1 = require("./index");
exports.app = new zod_openapi_1.OpenAPIHono();
exports.app.get("/docs", (0, swagger_ui_1.swaggerUI)({
    url: "/api-docs",
}));
exports.app.doc("/api-docs", {
    openapi: "3.1.0",
    info: {
...
exports.swaggerConfig = {
    ...
    servers: [
        {
            url: `http://${index_1.config.server.host}:${index_1.config.port}`,
    ...
    paths: {
        "/metadata": {
            get: {
                ...
                description: "Retrieve a paginated list of metadata records with optional filtering",
                parameters: [
                    {
                        name: "page",
                        in: "query",
        ...
        "/metadata/{id}": {
            ...
            put: {
                ...
                description: "Update an existing metadata record with the provided data",
                requestBody: {
                    required: true,
                    content: {
                        "application/json": {
