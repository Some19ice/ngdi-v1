...
CREATE TABLE "Metadata" (
    ...
    "resolution" TEXT,
    "coordinateUnit" TEXT NOT NULL DEFAULT 'DD',
    "minLatitude" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "minLongitude" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "maxLatitude" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "maxLongitude" DOUBLE PRECISION NOT NULL DEFAULT 0,
